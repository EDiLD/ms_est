...
\begin{enumerate}
	...
	\item Chemicals: Chemical names and identifiers have been unified using the webchem package (\url{https://github.com/ropensci/webchem}).
...
\begin{figure}[ht]
	...
	\caption{Distribution the number of quantified compounds in the samples from small streams.}
	\label{fig:pmix}
\end{figure}
