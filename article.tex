...
However, currently there is no curated nation-wide compilation of this monitoring data available.
...
We homogenized and unified all data provided by the federal states into a common database and implemented a robust data cleaning workflow (see Supplemental Figure~S1 for details on data processing) \citep{poisot_best_2015}.
...
For example, the herbicide Diflufenican showed highest RQ during the winter quarters (Supplemental Table~S4), which is application period in the German registration \citep{bvl_online_2016}.
