...
This indicates thresholds at 25\%, above chemical pollution from agriculture can be detected, and 75\% above pollution increases. \todo{discussion?}
...
The number of EQS-exceedances and the 95th percentile of $TU_{max}$ showed the same patterns (see Supplement Figure Sxxx - Sxxx). \todo{references}.
...
i) small, agricultural streams (catchment size \textless 30 km\textsuperscript{2} and agriculture \textgreater 40\%, n = 842 sites);
ii) small, non-agricultural streams (catchment size \textless 30 km\textsuperscript{2} and agriculture \textless 10\%, n = 254 sites);
iii) medium sized, agricultural streams (30 km\textsuperscript{2} $\le$ catchment size \textless 150 km\textsuperscript{2} and agriculture \textgreater 40\%, n = 489 sites);
iv) medium sized, non-agricultural streams (30 km\textsuperscript{2} $\le$ catchment size \textless 150 km\textsuperscript{2} and agriculture \textless 10\%, n = 160 sites).
