...
Given the fixed term monitoring design \todo{cite stehle 2012} and the low amount of samples taken at precipitation events that could lead to run-off, the data resents a strong underestimation of the real pollution and peak concentrations.
Automatic water samplers triggered at precipitation or passive samplers \todo{cite moschet and fernandez}.
