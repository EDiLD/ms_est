...
The analysed dataset comprised 42899 samples from 3049 sampling sites (Figure \ref{fig:fig1} and Supplement, Table \todo{Set ref to table}). 
We found big differences in the number of sampling sites between federal states.

484 compounds that could be classified as pesticides and their metobalites (Supplement, Table \todo{Set ref to table}) . 
