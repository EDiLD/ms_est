...
We used Multidimensional Scaling (MDS) based on jeccard dissimilarity in conjunction with hierarchical clustering to display differences in the spectra of analysed compounds per federal state.
