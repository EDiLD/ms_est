...
% wäre es nicht besser Stone 2014 ES&T für die USA zu nehmen? Der Link verweist ja gerade auf Daten die nicht aufbereitet sind usw.
The data compiled and analysed here for Germany is of similar quantity and quality.
%zumindest mit bezug auf die US Daten stimmt diese aussage nicht
...
% likely can be defined (0.5 it seems?) 
...
%kurze beschreibung welche Gewässer und Region
...
%Argument nicht ganz klar - sample size beeinflusst pollution state? Ansonsten ist das doch das gleiche argument, dass gradient insgesamt nur 10-100 war...
