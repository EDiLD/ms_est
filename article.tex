...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[Pesticides small streams]{Large scale exposure and risk from pesticides in small streams}
...
Although it is known that pesticide pollution and its ecological effects increase with agricultural land-use \citep{schulz_field_2004}, the shape of the relationship is unknown and studies on potential thresholds are lacking.
...
Despite these data providing the opportunity to study research questions that require large scale data with a high spatial density, to date these data have not been compiled and related analyses are lacking. 
...
Meta-analyses using data from studies with a few sites reported higher pesticide pollution in smaller streams compared to bigger streams \citep{stehle_pesticide_2015,schulz_field_2004}.
...
Then we analyse the form of relationship between pesticide exposure, agricultural land use and catchment size.
Further, we investigate the influence of precipitation and seasonal dynamics of measure pesticide concentrations. 
Finally, we give an overview on current pesticide pollution of SWB in Germany.
...
We homogenized and unified all data provided by the federal states into a common database and implemented a robust data cleaning workflow (see Supplemental Figure~S1 for details) \citep{poisot_best_2015}.
...
We were not able to compile catchment size data for 10\% of the sites.
