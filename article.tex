...
Small water bodies are important refuges of biodiversity \citep{davies_comparison_2008} and enabling downstream colonisation of 
...
% Although small waterbodies make up most

% running  water  
% with  at  least  10km2  catchment  area

% However, very little is know about the pollution of such streams. 
% The 
...
(i) Is the currently available monitoring data a representative description of the pollution situation? \\
(ii) Are small agricultural waters more polluted compared to bigger streams? Are there thresholds? \\
(iii)  How polluted are small streams and which pesticides are responsible?
...
The compiled dataset comprised only a small fraction of standing waters and most of the samples where sampled via grab sampling. \todo{zahlen}
Therefore, we report only results for grab sampling from streams. 

The analysed dataset comprised 42236 samples from 3049 sampling sites (Figure \ref{fig:fig1} and Supplement). 
