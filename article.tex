...
They found exceedances in 37.1\% of measurements \textgreater LOQ (n = 1352, 23 insecticides), whereas, we found exceedances in 67\% of measurements \textgreater LOQ (n = 1855, 22 insecticides).
...
Moreover, all RACs were lower in our study (mean = -0.71 $\mu g/L$, range = [-2.7570; -0.0045]). 
