...
\section{Results}
\subsection{Overview on compiled data}

The compile dataset comprised only a small fraction of stand waters and most of the samples where sampled via grab sampling.
Therefore, we report  only results from streams and grab sampling.
