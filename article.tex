...
Agricultural land use lead to an 3.4-fold increase in exceedance of risk thresholds once the proportion of agriculture in a catchment exceeded 25 percent. 
Precipitation increased measured pesticide risk by 5\% and was highest risk  during summer months.
Risk thresholds were exceeded in 26 percent of small streams, with highest risk emerging from neonicotinoid insecticides. 
...
Despite their ecological relevance and potentially higher pesticide exposure, a recent analysis of pesticide studies showed that a disproportionally small fraction of studies were conducted in small water bodies, and these were largely limited to a few sites \citep{lorenz_specifics_2016}. 
...
We fitted this model separately to each compound with a RAC, measured in least 1000 samples and with more than 5\% of values above LOQ (n = 23 compounds, see Supplemental Table~S3 for a list of compounds). 
...
Effect on individual compounds are provided in the Supplemental Table~S4.
...
In 23\% of sites chemicals with RAC where never detected (see also Supplemental Figure~S8).
Neonicotinoid insecticides and Chlorpyrifos showed the highest RQ (Figure~\ref{fig:fig6}). %do_pollution.R
For Thiacloprid and Chlorpyrifos the RAC was less than LOQ, therefore, all detections have a RQ~\textgreater~1. 
...
Although, the outlined differences between states, all ecoregions occuring Germany \citep{illies1978limnofauna,abell2008freshwater} are covered by the presented dataset and therefore, may represent a sample of all small streams in Central Europe. 
...
\citet{feld_response_2013} found change points of biological community metrics at 40\% agricultural land use in low land streams in Europe.
...
Nevertheless, we found a 5\% higher RQ if samples where taken after rainfall events. 
...
In one quarter of small streams RAC were exceeded at least once.
