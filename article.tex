...
We used the number of samplings ($n_i$) as an offset to account different sampling efforts. 
...
Similar models were fitted to the number of EQS-exceedances and the 95th percentile of $log(TU_{max})$ (see Supplement for details). \todo{TRUE?}
GAM were fitted using the mgcv package \citep{wood_fast_2011}.
