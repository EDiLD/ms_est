...
\todo{Check all references to supplement}.
...
\todo{add alternatives - passive sampler, automatic samplers...}
...
Hence, we also found the hightest RQ for the herbicide Diflufenican during the winter/spring season, which is application period for which it is registered \todo{cite BVL}. 
