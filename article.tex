...
Moreover, if agricultural land use is a main source for pesticides in streams, we expect that exceedances drop to zero if there is not agricultural land use in the catchment. 
...
As outlined in the introduction, we expected non-linear responses to agricultural land use and catchment size and search for potential thresholds.
...
This difference was less pronounced for the mean value of RQ (Supplemental Figure~S7). 
Moreover, effects differed between individual compounds and are provided in the Supplemental Table~S4. 
...
\todo{more dicussion here?;drop shows the agri is important; compare to linear fit}
